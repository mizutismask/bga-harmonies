...
$this->ANIMAL_CARDS = [
  1 => [
    1 => new AnimalCardInfo([15, 9, 4], [new PatternHex([GREEN, BROWN, BROWN], 0, 0, false), new PatternHex([BLUE], 1, 0, false), new PatternHex([BLUE], 2, 1, true)]),
    ...
    4 => new AnimalCardInfo([16, 10, 5], [new PatternHex([GREEN], 0, 0, false), new PatternHex([GREEN], 1, 0, false), new PatternHex([BLUE], 2, 1, true)]),
    5 => new AnimalCardInfo([15, 10, 6, 4, 2], [new PatternHex([GREEN], 0, 0, false),  new PatternHex([BLUE], 1, 0, true)]),
    6 => new AnimalCardInfo([13, 8, 4, 2], [new PatternHex([RED, BUILDING,], 0, 0, false), new PatternHex([BLUE], 1, 0, true)]),
  ]
];
