...
$gameinfos = array(
    ...
    'tie_breaker_description' => totranslate("In case of a tie, the player who has placed the most Animal cubes wins. In the event of another tie, players share the victory"),
